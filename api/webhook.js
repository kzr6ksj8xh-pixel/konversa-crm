...
→ NO uses el saludo genérico. Responde con la FICHA COMPLETA del producto en este ORDEN (beneficios primero, precio al final):
  1. Nombre del producto
  2. Beneficio principal: "Elimina el 99.6% de bacterias, virus y patógenos del aire"
...
🔬 CÓMO FUNCIONA EL OZONO — INFORMACIÓN PARA EL CLIENTE:
Cuando el cliente pregunte "cómo funciona", "qué es el ozono", "es seguro", "de verdad mata virus" o similar, usa estos datos (respaldados por la OMS y la EPA):
1. Generación: el equipo toma oxígeno del aire (O₂) y mediante descarga eléctrica le añade un tercer átomo, creando ozono (O₃).
2. Acción antimicrobiana: el O₃ oxida la membrana celular de bacterias (E. coli, Salmonella, Listeria) y la cápside proteica de virus (Influenza, SARS-CoV-2), destruyéndolos por contacto.
3. Sin residuos: después de actuar, el O₃ se descompone y vuelve a ser oxígeno puro (O₂). No deja químicos ni olores artificiales.
4. Eficacia comprobada: elimina el 99.9% de bacterias y virus. Es 50 veces más eficaz y 3,000 veces más rápido que el cloro (dato de potencial de oxidación-reducción ORP).
5. Seguridad: nuestros equipos trabajan en ciclos cortos (ej: 15 min ON / 30 min OFF) con niveles de ozono residual muy bajos. Totalmente seguro para personas, niños y mascotas.
IMPORTANTE: responde de forma breve (máx 3 líneas). Usa 1-2 datos clave, no la lista completa. Si insiste, profundiza paso a paso.
...
⚠️ PRECIOS VIGENTES — REGLA CRÍTICA: Los ÚNICOS precios válidos y actuales son los de este CATÁLOGO y, si existe, los de la BASE DE CONOCIMIENTO sincronizada desde Google Drive (esa base manda sobre todo lo demás). Si en el historial de esta conversación aparece CUALQUIER precio distinto para un producto, estaba DESACTUALIZADO: ignóralo por completo y cotiza SIEMPRE con el precio vigente. Si un precio viejo ya se mencionó antes en la conversación, corrígelo con naturalidad usando el vigente. NUNCA repitas un precio del historial que no coincida con el precio vigente, y NUNCA cites precios de memoria: usa solo los del catálogo / Drive.
...
const FALLBACK_RESPONSES = {
  ...
  'mercado libre': 'Sí, también estamos en Mercado Libre. En nuestra tienda en línea (grupopingus.com) manejamos mejores precios, pero también los puede adquirir en Mercado Libre sin el descuento de la tienda en línea:\n\n- P4: https://www.mercadolibre.com.mx/purificador-de-aire-p4-para-eliminar-virus-y-bacterias-color-blanco/p/MLM35289256\n- CIR 150: https://www.mercadolibre.com.mx/purificador-de-aire-pingus-cir-150-con-generador-de-ozono/up/MLMU3917226485\n- ULTRA 150: https://www.mercadolibre.com.mx/generador-de-ozono-inteligente-ultra-150mgh-uv-c-para-purificar-aire-y-eliminar-olores/p/MLM64646338\n- AQUA 500: https://www.mercadolibre.com.mx/pingus-aqua-500-generador-de-ozono-casa-para-aire-y-agua/up/MLMU1012393684\n- AQUA 1000: https://www.mercadolibre.com.mx/pingus-aqua-1000-generador-de-ozono-casa-para-aire-y-agua/up/MLMU1008857879',
  'mercadolibre': 'Sí, también estamos en Mercado Libre. En nuestra tienda en línea (grupopingus.com) manejamos mejores precios, pero también los puede adquirir en Mercado Libre sin el descuento de la tienda en línea:\n\n- P4: https://www.mercadolibre.com.mx/purificador-de-aire-p4-para-eliminar-virus-y-bacterias-color-blanco/p/MLM35289256\n- CIR 150: https://www.mercadolibre.com.mx/purificador-de-aire-pingus-cir-150-con-generador-de-ozono/up/MLMU3917226485\n- ULTRA 150: https://www.mercadolibre.com.mx/generador-de-ozono-inteligente-ultra-150mgh-uv-c-para-purificar-aire-y-eliminar-olores/p/MLM64646338\n- AQUA 500: https://www.mercadolibre.com.mx/pingus-aqua-500-generador-de-ozono-casa-para-aire-y-agua/up/MLMU1012393684\n- AQUA 1000: https://www.mercadolibre.com.mx/pingus-aqua-1000-generador-de-ozono-casa-para-aire-y-agua/up/MLMU1008857879',
  'ozono': 'El ozono (O₃) es oxígeno con un tercer átomo que oxida y destruye bacterias (E. coli, Salmonella) y virus (Influenza, SARS-CoV-2) por contacto. Según la OMS y la EPA, es 50x más eficaz que el cloro y no deja residuos — se convierte en oxígeno puro. Nuestros equipos lo generan en ciclos cortos controlados, totalmente seguros. ¿Te interesa para algún espacio en particular?',
